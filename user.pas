...
procedure TForm4.ChargerStringGrid1;
var
  Col: TStringColumn;
  i: Integer;
begin
  ...
  try
    ...
    Col := TStringColumn.Create(StringGrid1);
    Col.Header := 'Nom et Prénom';
    Col.Width := 400;
    StringGrid1.AddObject(Col);

    Col := TStringColumn.Create(StringGrid1);
    Col.Header := 'Catégorie';
    Col.Width := 120;
    StringGrid1.AddObject(Col);
...
//    StringGrid1.Cells[2, 0] := 'Catégorie';
    ...
    begin
      ...
      try
        ...
        begin
          ...
          // Catégorie
          StringGrid1.Cells[2, i] := FieldByName('categorie').AsString;
...
begin
        Caption := 'GESTION DE GROUPE (Utilisateur)';
        Initialisation;
       ChargerStringGrid1
  // (Optionnel) Si tu veux un effet de sélection sur toute la ligne :
  // en FMX, ça se fait via les propriétés du style (pas via Options)
  // Exemple : StringGrid1.SelectionMode := TGridSelectionMode.RowRange;
end;
